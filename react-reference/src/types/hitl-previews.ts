...
export interface ComboPreview extends BasePreview {
  type: 'combo_preview'
  operation: 'add_product' | 'remove_product' | 'update_product' | 'add_modifier' | 'remove_modifier' | 'activate' | 'deactivate'
  combo: {
    id: string
    name?: string
    description?: string
...
export interface PromotionPreview extends BasePreview {
  ...
  operation: 'add_product' | 'remove_product' | 'add_category' | 'remove_category' | 'activate' | 'deactivate' | 'extend'
  promotion: {
    id: string
    name?: string
    description?: string
