...
<template>
  <aside
    class="flex flex-col h-full bg-gray-50 border-r border-gray-200 transition-all duration-300"
  ...
  >
    ...
    <!-- New Chat Button -->
    <div class="p-3">
      <FdxButton class="w-full" :class="isCollapsed ? 'px-2' : ''" @click="handleNewSession">
        <Plus class="w-5 h-5" />
        <span v-if="!isCollapsed" class="ml-2">New Chat</span>
      </FdxButton>
    </div>
            ...
            <div class="space-y-1">
              ...
              >
                ...
                <div
                  ...
                  class="absolute right-2 top-full z-10 mt-1 w-36 py-1 bg-white rounded-lg shadow-lg border border-gray-200"
                >
                  <button
